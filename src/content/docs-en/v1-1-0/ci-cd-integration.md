...
- [Why Architect in CI/CD](#why-architect-in-cicd)
- [Headless execution principles](#headless-execution-principles)
...
architect run "PROMPT" \
  ...
  --report-file PATH \       # Save report to file (format inferred from extension if --report not set)
...
### Output language (v1.1.0)

System messages (HUMAN logs, reports, guardrails) are in **English by default**. If you need output in Spanish, set the env var `ARCHITECT_LANGUAGE=es` or `language: es` in the YAML.
...
- **Containers**: [`containers.md`](/architect-docs/en/docs/v1-1-0/containers) -- Dockerfiles, Kubernetes and OpenShift
- **Reports**: [`reports.md`](/architect-docs/en/docs/v1-1-0/reports) -- JSON, Markdown and GitHub formats
- **Sessions**: [`sessions.md`](/architect-docs/en/docs/v1-1-0/sessions) -- persistence and resume
- **Ralph Loop**: [`ralph-loop.md`](/architect-docs/en/docs/v1-1-0/ralph-loop) -- automatic iteration with checks
- **Parallel**: [`parallel.md`](/architect-docs/en/docs/v1-1-0/parallel) -- parallel execution in worktrees
- **Pipelines**: [`pipelines.md`](/architect-docs/en/docs/v1-1-0/pipelines) -- multi-step YAML workflows
- **Security**: [`security.md`](/architect-docs/en/docs/v1-1-0/security) -- complete security model
- **Dry Run**: [`dryrun.md`](/architect-docs/en/docs/v1-1-0/dryrun) -- execution simulation
- **Quick Guide**: [`fast-usage.md`](/architect-docs/en/docs/v1-1-0/fast-usage) -- daily usage reference

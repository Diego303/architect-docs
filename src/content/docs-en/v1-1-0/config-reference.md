...
| `--report-file PATH` | Write report to file (format inferred from extension if `--report` not passed) |
...
# ==============================================================================
# Language — system message language (v1.1.0)
# ==============================================================================
language: en               # "en" (default) | "es"
                           # Affects: human logs, agent prompts, reports,
                           # guardrails, evaluations. Does NOT affect CLI help or user prompts.
                           # Override: ARCHITECT_LANGUAGE env var
                           # See docs/i18n.md for full details.
...
guardrails:
  ...
  protected_files: []         # globs — write-only: ["*.lock", "Makefile"]
  sensitive_files: []         # globs — read + write: [".env", "*.pem", "*.key"]

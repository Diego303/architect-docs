...
> **v1.1.0**: HUMAN pipeline messages now support i18n (English by default, Spanish configurable). The examples on this page show the English format (default). See [`i18n.md`](/architect-docs/en/docs/v1-1-0/i18n).
...
> **v1.1.0**: The HUMAN output language depends on the `language` configuration (default: `en`). See [`i18n.md`](/architect-docs/en/docs/v1-1-0/i18n).
...
With `language: es` in the configuration:
...
> The examples show the English format (default). With `language: es`, the messages are shown in Spanish.

| Event | Format (EN) | Icon |
|--------|---------|-------|
...
| `ralph.checks_result` | `🧪 Checks: 3/5 passed` (or `5/5 passed ✓`) | 🧪 |
...
See [`telemetry.md`](/architect-docs/en/docs/v1-1-0/telemetry) for OpenTelemetry configuration.

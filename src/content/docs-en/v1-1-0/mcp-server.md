...
- [Implementation: tools.py](#implementation-toolspy)
- [Implementation: server.py](#implementation-serverpy)
- [Running and testing](#running-and-testing)
- [Connecting from architect as a client](#connecting-from-architect-as-a-client)

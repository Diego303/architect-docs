...
Sessions and reports (v4-B)
  ...
  --report-file PATH        Write report to file (format inferred from extension if --report not set)
...
guardrails:
  ...
  # Sensitive files — blocks read AND write (v1.1.0)
  sensitive_files:
    - ".env"
    - "*.pem"
    - "*.key"
  ...
  # Protected files — blocks write only (allows read)
  protected_files:
    - "Dockerfile"
    - "*.lock"
...
See full documentation: [`sessions.md`](/architect-docs/en/docs/v1-1-0/sessions).
...
See full documentation: [`reports.md`](/architect-docs/en/docs/v1-1-0/reports).
...
See full documentation: [`ralph-loop.md`](/architect-docs/en/docs/v1-1-0/ralph-loop).
...
See full documentation: [`pipelines.md`](/architect-docs/en/docs/v1-1-0/pipelines).
...
See full documentation: [`parallel.md`](/architect-docs/en/docs/v1-1-0/parallel).
...
See full documentation: [`checkpoints.md`](/architect-docs/en/docs/v1-1-0/checkpoints).
...
See full documentation: [`auto-review.md`](/architect-docs/en/docs/v1-1-0/auto-review).
...
See full documentation: [`eval.md`](/architect-docs/en/docs/v1-1-0/eval).
...
See full documentation: [`health.md`](/architect-docs/en/docs/v1-1-0/health).
...
See full documentation: [`presets.md`](/architect-docs/en/docs/v1-1-0/presets).
...
See full documentation: [`dispatch-subagent.md`](/architect-docs/en/docs/v1-1-0/dispatch-subagent).
...
See full documentation: [`telemetry.md`](/architect-docs/en/docs/v1-1-0/telemetry).

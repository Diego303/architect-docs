---
title: "Introducción"
description: "Índice de la documentación técnica del proyecto Architect v0.16.2."
...
| Archivo | Contenido |
|---------|-----------|
| [`usage.md`](/architect-docs/docs/v0-16-2/usage) | **Formas de uso**: flags, logging, configs, CI/CD, scripts, agentes custom, multi-proyecto |
| [`architecture.md`](/architect-docs/docs/v0-16-2/architecture) | Visión general, diagrama de componentes y flujo completo de ejecución |
| [`core-loop.md`](/architect-docs/docs/v0-16-2/core-loop) | El loop while True, safety nets, StopReason, graceful close, hooks lifecycle, human logging, ContextManager, parallel tools, SelfEvaluator |
| [`data-models.md`](/architect-docs/docs/v0-16-2/data-models) | Todos los modelos de datos: Pydantic, dataclasses, jerarquía de errores |
| [`tools-and-execution.md`](/architect-docs/docs/v0-16-2/tools-and-execution) | Sistema de tools: filesystem, edición, búsqueda, MCP, ExecutionEngine |
| [`agents-and-modes.md`](/architect-docs/docs/v0-16-2/agents-and-modes) | Agentes por defecto, registry, prompts del sistema |
| [`config-reference.md`](/architect-docs/docs/v0-16-2/config-reference) | Schema completo de configuración, precedencia, variables de entorno |
| [`logging.md`](/architect-docs/docs/v0-16-2/logging) | **Sistema de logging**: 3 pipelines, nivel HUMAN, iconos, HumanFormatter, structlog |
| [`ai-guide.md`](/architect-docs/docs/v0-16-2/ai-guide) | Guía para IA: invariantes críticos, patrones, dónde añadir cosas, trampas |
| [`testing.md`](/architect-docs/docs/v0-16-2/testing) | Mapa de tests: ~713 tests en 29 archivos, cobertura por módulo |
| [`containers.md`](/architect-docs/docs/v0-16-2/containers) | **Contenedores**: Containerfiles (root, non-root, OpenShift), Kubernetes Deployments, Docker, configuración para CI/CD |
...
| [`fast-usage.md`](/architect-docs/docs/v0-16-2/fast-usage) | **Guía rápida**: instalación, configuración mínima, comandos más útiles y referencia de flags |
| [`mcp-server.md`](/architect-docs/docs/v0-16-2/mcp-server) | **MCP Server**: cómo crear un servidor MCP que exponga architect como herramienta remota (server.py + tools.py completos) |
| [`good-practices.md`](/architect-docs/docs/v0-16-2/good-practices) | **Buenas prácticas**: prompts, agentes, edición, costes, hooks lifecycle, guardrails, skills, memoria, auto-evaluación, CI/CD, errores comunes |
| [`security.md`](/architect-docs/docs/v0-16-2/security) | **Modelo de seguridad**: 19 capas defensivas, modelo de amenazas, path traversal, command security, prompt injection, hardening |

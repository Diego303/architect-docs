...
description: "13+ capas defensivas, modelo de amenazas, path traversal, command security, hardening."
...
Ver [`containers.md`](/architect-docs/docs/v0-18-0/containers) para Containerfiles completos.

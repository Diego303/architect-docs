...
- **Contenedores**: [`containers.md`](/architect-docs/docs/v1-0-0/containers) -- Dockerfiles, Kubernetes y OpenShift
- **Reportes**: [`reports.md`](/architect-docs/docs/v1-0-0/reports) -- formatos JSON, Markdown y GitHub
- **Sesiones**: [`sessions.md`](/architect-docs/docs/v1-0-0/sessions) -- persistencia y resume
- **Ralph Loop**: [`ralph-loop.md`](/architect-docs/docs/v1-0-0/ralph-loop) -- iteración automática con checks
- **Parallel**: [`parallel.md`](/architect-docs/docs/v1-0-0/parallel) -- ejecución paralela en worktrees
- **Pipelines**: [`pipelines.md`](/architect-docs/docs/v1-0-0/pipelines) -- workflows YAML multi-step
- **Seguridad**: [`security.md`](/architect-docs/docs/v1-0-0/security) -- modelo de seguridad completo
- **Dry Run**: [`dryrun.md`](/architect-docs/docs/v1-0-0/dryrun) -- simulación de ejecución
- **Guía rápida**: [`fast-usage.md`](/architect-docs/docs/v1-0-0/fast-usage) -- referencia de uso diario

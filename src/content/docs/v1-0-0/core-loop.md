...
El `AgentLoop` es el corazón del sistema. Ver también [`logging.md`](/architect-docs/docs/v1-0-0/logging) para detalles del sistema de logging.
...
A partir de v1.0.0, el agente `build` también tiene acceso a `dispatch_subagent` como tool adicional, que permite delegar sub-tareas a agentes con contexto aislado. Ver [`tools-and-execution.md`](/architect-docs/docs/v1-0-0/tools-and-execution) para detalles.

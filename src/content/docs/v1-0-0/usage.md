---
title: "Uso del CLI"
description: "Guía práctica de uso: flags, logging, configs, CI/CD, scripts, agentes custom."
...
Ver documentación completa: [`sessions.md`](/architect-docs/docs/v1-0-0/sessions).
...
Ver documentación completa: [`reports.md`](/architect-docs/docs/v1-0-0/reports).
...
Ver documentación completa: [`ralph-loop.md`](/architect-docs/docs/v1-0-0/ralph-loop).
...
Ver documentación completa: [`pipelines.md`](/architect-docs/docs/v1-0-0/pipelines).
...
Ver documentación completa: [`parallel.md`](/architect-docs/docs/v1-0-0/parallel).
...
Ver documentación completa: [`checkpoints.md`](/architect-docs/docs/v1-0-0/checkpoints).
...
Ver documentación completa: [`auto-review.md`](/architect-docs/docs/v1-0-0/auto-review).
...
Ver documentación completa: [`eval.md`](/architect-docs/docs/v1-0-0/eval).
...
Ver documentación completa: [`health.md`](/architect-docs/docs/v1-0-0/health).
...
Ver documentación completa: [`presets.md`](/architect-docs/docs/v1-0-0/presets).
...
Ver documentación completa: [`dispatch-subagent.md`](/architect-docs/docs/v1-0-0/dispatch-subagent).
...
Ver documentación completa: [`telemetry.md`](/architect-docs/docs/v1-0-0/telemetry).

...
> **v1.1.0**: Los mensajes del pipeline HUMAN ahora soportan i18n (inglés por defecto, español configurable). Los ejemplos en esta página muestran el formato inglés (default). Ver [`i18n.md`](/architect-docs/docs/v1-1-0/i18n).
...
> **v1.1.0**: El idioma del output HUMAN depende de la configuración `language` (default: `en`). Ver [`i18n.md`](/architect-docs/docs/v1-1-0/i18n).
...
Ver [`telemetry.md`](/architect-docs/docs/v1-1-0/telemetry) para configuración de OpenTelemetry.

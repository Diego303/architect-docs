...
description: "22+ capas defensivas, modelo de amenazas, path traversal, sensitive files, command security, hardening."
...
Ver [`containers.md`](/architect-docs/docs/v1-1-0/containers) para Containerfiles completos.

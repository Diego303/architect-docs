...
description: "Diagnóstico por síntomas: errores LLM, loops, tools, hooks, guardrails, exit codes."
...
> **Nota v1.1.0**: Los mensajes HUMAN ahora están en inglés por defecto. Con `language: es`, se muestran en español. Ver [`i18n.md`](/architect-docs/docs/v1-1-0/i18n).

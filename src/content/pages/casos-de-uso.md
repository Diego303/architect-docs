...
- [Evaluación, Health, Presets y Sub-Agentes](#evaluación-health-presets-y-sub-agentes)
  - [Selección de modelo por tipo de tarea](#selección-de-modelo-por-tipo-de-tarea)
  - [Monitoreo de calidad del código](#monitoreo-de-calidad-del-código)
  - [Onboarding de equipos con presets](#onboarding-de-equipos-con-presets)
  - [Delegación de investigación a sub-agentes](#delegación-de-investigación-a-sub-agentes)
  - [Observabilidad con OpenTelemetry](#observabilidad-con-opentelemetry)
